...
void ofApp::draw(){
    ...
    string coords = "/mouse/position is " + ofToString(mouseXf*ofGetWidth()) + ", " + ofToString(mouseYf*ofGetHeight());
    ofDrawBitmapStringHighlight(coords, 10, 40);
    ...
    ofSetColor(r, g, b);
    ofSetCircleResolution(numCircPnts);
	ofDrawCircle(mouseIn, size);
